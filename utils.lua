function apply_properkorean()
	...
	if is_korean then
		...
		local font_path = mod_path .. "ONEStorePOP.ttf"
														...
														nodes = {
															{
																n = G.UIT.T,
																config = {
																	text = 'uair01 (https://freesound.org/people/uair01/sounds/65195/) 이 제작한 "chamber_choir_chord_o.wav" (폴리크롬 효과에 사용됨) 는',
																	scale = text_scale * 0.5,
																	colour = G.C.UI.TEXT_LIGHT,
																	shadow = true,
																},
														...
														nodes = {
															{
																n = G.UIT.T,
																config = {
																	text = 'Nathan Gibson (https://nathangibson.myportfolio.com) 이 제작한 "Coffee1.wav" (타로 카드 효과에 사용됨) 는',
																	scale = text_scale * 0.5,
																	colour = G.C.UI.TEXT_LIGHT,
																	shadow = true,
																},
														...
														nodes = {
															{
																n = G.UIT.T,
																config = {
																	text = 'Nathan Gibson (https://nathangibson.myportfolio.com) 이 제작한 "Wood Block1.wav" (타로 카드 효과에 사용됨) 는',
																	scale = text_scale * 0.5,
																	colour = G.C.UI.TEXT_LIGHT,
																	shadow = true,
																},
														...
														nodes = {
															{
																n = G.UIT.T,
																config = {
																	text = 'poissonmort (https://freesound.org/people/poissonmort/sounds/253249/) 이 제작한 "Toy records#06-E3-02.wav" (배수 효과에 사용됨) 은',
																	scale = text_scale * 0.5,
																	colour = G.C.UI.TEXT_LIGHT,
																	shadow = true,
																},
												...
												nodes = {
													{
														n = G.UIT.T,
														config = {
															text = "이곳에 언급되지 않은 모든 스프라이트, 셰이더 및",
															scale = text_scale * 0.6,
															colour = G.C.UI.TEXT_LIGHT,
															shadow = true,
														},
												...
												nodes = {
													{
														n = G.UIT.T,
														config = {
															text = "기타 비주얼 에셋은 LocalThunk가 제작했습니다.",
															scale = text_scale * 0.6,
															colour = G.C.UI.TEXT_LIGHT,
															shadow = true,
														},
														...
														nodes = {
															{
																n = G.UIT.T,
																config = {
																	text = 'Daniel Linssen (https://managore.itch.io/m6x11) 가 제작한 폰트 "m6x11.ttf"는',
																	scale = text_scale * 0.5,
																	colour = G.C.UI.TEXT_LIGHT,
																	shadow = true,
																},
																...
																nodes = {
																	{
																		n = G.UIT.T,
																		config = {
																			text = "Daniel의 itch.io 프로필을 확인해 보세요. 굉장한 게임들로 가득합니다.",
																			scale = text_scale * 0.5,
																			colour = G.C.UI.TEXT_LIGHT,
																			shadow = true,
																		},
														...
														nodes = {
															{
																n = G.UIT.T,
																config = {
																	text = '"방랑자" 조커는 Lumpy Touch가 제작했습니다',
																	scale = text_scale * 0.5,
																	colour = G.C.UI.TEXT_LIGHT,
																	shadow = true,
																},
